        ...
        <>
            <div className="body">
                <header className="header">
                    ...
                    <p class="textotop"><b><i>LKCAM</i></b></p>
                </header>
                <div className="foto-capa"></div>

                <div className="container">
                    <div className="item">
                        <img src="https://sm.pcmag.com/t/pcmag_uk/review/c/canon-eos-/canon-eos-r5_p5vj.1920.jpg"
                            alt="Câmera Canon EOS R5" />
                        <div className="preço">R5: R$ 31.000,00</div>
                        <h5>CANON EOS R5 (CORPO)</h5>
                    </div>
                    <div className="item">
                        <img src="https://lucaslapablog.com.br/wp-content/uploads/2023/09/image-6-1024x683.png"
                            alt="FX30" />
                    ...
                    <div className="item">
                        <img src="https://th.bing.com/th/id/OIP._uZHXrTobqawvUECqQQBzgHaEK?rs=1&pid=ImgDetMain"
                            alt="blackpocket G2" />
